 ...
 *    ECKERT6, EQUIDISTANT CYLINDRICAL, GARS, GNOMONIC, LOCAL CARTESIAN, LOCAL SPHERICAL
 *    MILLER, MOLLWEIDE, NEYS, NEW ZEALAND MAP GRID, OBLIQUE MERCATOR,
 *    ORTHOGRAPHIC, POLYCONIC, SINUSOIDAL, SPHERICAL, STEREOGRAPHIC,
 ...
 *              and UTM. 
 *    10/08/17  M. Thakkar : LSC-5331 : Fixed array index for sinusoidal
 *    06/25/18 K. Lam MSP-459 Update service version for MSP 1.6
 *    07/03/18 C. Wendling : GTR-15 - Fixed IF block at 2235 brackets to
 *             include the rest of the special cases.
 *    04/30/19 K. Lam GTR-28 Update service version for Geotrans 3.8
 *    01/27/22 K. Lam GTRU-15 Update service version for Geotrans 3.9
 */
   ...
   WGS84_datum_index( 0 )
{
  ...
  Coordinate_System_Table[CoordinateType::albersEqualAreaConic].set( "Albers Equal Area Conic", "AC" );
  Coordinate_System_Table[CoordinateType::azimuthalEquidistant].set( "Azimuthal Equidistant (S)", "AL" );
  Coordinate_System_Table[CoordinateType::bonne].set( "Bonne", "BF" );
  Coordinate_System_Table[CoordinateType::britishNationalGrid].set( "British National Grid (BNG)", "BN" );
  Coordinate_System_Table[CoordinateType::cassini].set( "Cassini", "CS" );
  Coordinate_System_Table[CoordinateType::cylindricalEqualArea].set( "Cylindrical Equal Area", "LI" );
  Coordinate_System_Table[CoordinateType::eckert4].set( "Eckert IV (S)", "EF" );
  Coordinate_System_Table[CoordinateType::eckert6].set( "Eckert VI (S)", "ED" );
  Coordinate_System_Table[CoordinateType::equidistantCylindrical].set( "Equidistant Cylindrical (S)", "CP" );
  Coordinate_System_Table[CoordinateType::geocentric].set( "Geocentric", "GC" );
  Coordinate_System_Table[CoordinateType::geodetic].set( "Geodetic", "GD" );
  Coordinate_System_Table[CoordinateType::georef].set( "GEOREF", "GE" );
  Coordinate_System_Table[CoordinateType::globalAreaReferenceSystem].set( "Global Area Reference System (GARS)", "GA" );
  Coordinate_System_Table[CoordinateType::gnomonic].set( "Gnomonic (S)", "GN" );
  Coordinate_System_Table[CoordinateType::lambertConformalConic1Parallel].set( "Lambert Conformal Conic (1 Standard Parallel)", "L1" );
  Coordinate_System_Table[CoordinateType::lambertConformalConic2Parallels].set( "Lambert Conformal Conic (2 Standard Parallel)", "L2" );
  Coordinate_System_Table[CoordinateType::localCartesian].set( "Local Cartesian", "LC" );
  Coordinate_System_Table[CoordinateType::localSpherical].set( "Local Spherical", "LS" );
  Coordinate_System_Table[CoordinateType::mercatorStandardParallel].set( "Mercator (Standard Parallel)", "MC" );
  Coordinate_System_Table[CoordinateType::mercatorScaleFactor].set( "Mercator (Scale Factor)", "MF" );
  Coordinate_System_Table[CoordinateType::militaryGridReferenceSystem].set( "Military Grid Reference System (MGRS)", "MG" );
  Coordinate_System_Table[CoordinateType::millerCylindrical].set( "Miller Cylindrical (S)", "MH" );
  Coordinate_System_Table[CoordinateType::mollweide].set( "Mollweide (S)", "MP" );
  Coordinate_System_Table[CoordinateType::newZealandMapGrid].set( "New Zealand Map Grid (NZMG)", "NT" );
  Coordinate_System_Table[CoordinateType::neys].set( "Ney's (Modified Lambert Conformal Conic)", "NY" );
  Coordinate_System_Table[CoordinateType::obliqueMercator].set( "Oblique Mercator",	"OC" );
  Coordinate_System_Table[CoordinateType::orthographic].set( "Orthographic (S)", "OD" );
  Coordinate_System_Table[CoordinateType::polarStereographicStandardParallel].set( "Polar Stereographic (Standard Parallel)", "PG" );
  Coordinate_System_Table[CoordinateType::polarStereographicScaleFactor].set( "Polar Stereographic (Scale Factor)", "PF" );
  Coordinate_System_Table[CoordinateType::polyconic].set( "Polyconic", "PH" );
  Coordinate_System_Table[CoordinateType::sinusoidal].set( "Sinusoidal", "SA" );
  Coordinate_System_Table[CoordinateType::spherical].set( "Spherical", "SP" );
  Coordinate_System_Table[CoordinateType::stereographic].set( "Stereographic (S)", "SD" );
  Coordinate_System_Table[CoordinateType::transverseCylindricalEqualArea].set( "Transverse Cylindrical Equal Area", "TX" );
  Coordinate_System_Table[CoordinateType::transverseMercator].set( "Transverse Mercator", "TC" );
  Coordinate_System_Table[CoordinateType::universalPolarStereographic].set( "Universal Polar Stereographic (UPS)", "UP" );
  Coordinate_System_Table[CoordinateType::universalTransverseMercator].set( "Universal Transverse Mercator (UTM)", "UT" );
  Coordinate_System_Table[CoordinateType::usNationalGrid].set( "United States National Grid (USNG)", "US" );
  Coordinate_System_Table[CoordinateType::vanDerGrinten].set( "Van der Grinten", "VA");
  Coordinate_System_Table[CoordinateType::webMercator].set( "Web Mercator", "WM" );
  setDataLibraries();
...
int CoordinateConversionService::getServiceVersion()
{
  ...
  return 390; // update service version for geotrans 3.9
}
 ...
 */
  ...
  switch( coordinateSystemState[direction].coordinateType )
  {
    ...
    {
	  coordinateSystemState[direction].coordinateSystem =
	     new Spherical( semiMajorAxis, flattening );
	  break;
	}
    case CoordinateType::geodetic:
      coordinateSystemState[direction].coordinateSystem = 0;
    ...
    case CoordinateType::localSpherical: 
    {
	  ...
	  coordinateSystemState[direction].coordinateSystem = new LocalSpherical(
	     semiMajorAxis, flattening,
         param->longitude(),
         param->latitude(),
         param->height(),
 ...
 */
  ...
  switch( coordinateSystemState[direction].coordinateType )
  {
    ...
    case CoordinateType::spherical:
	  ...
	  if( coordinateSystemState[direction].coordinateSystem )
	  {
	    delete ((Spherical*)(coordinateSystemState[direction].coordinateSystem));
		coordinateSystemState[direction].coordinateSystem = 0;
		}
		break;	
	case CoordinateType::geodetic:
    ...
    case CoordinateType::localSpherical:
	  ...
	  if( coordinateSystemState[direction].coordinateSystem )
	  {
	    delete ((LocalSpherical*)(coordinateSystemState[direction].coordinateSystem));
		coordinateSystemState[direction].coordinateSystem = 0;
	  }
	  break;
	case CoordinateType::mercatorStandardParallel:
      ...
      /******************************/
        ...
        if (source->coordinateType == CoordinateType::geodetic)
          input_height_type = source->parameters.geodeticParameters->heightType();
				 ...
				 (source->coordinateType == CoordinateType::localSpherical) ||
				 (source->coordinateType == CoordinateType::spherical))
        ...
        if (target->coordinateType == CoordinateType::geodetic)
          output_height_type = target->parameters.geodeticParameters->heightType();
		         ...
		         (target->coordinateType == CoordinateType::localCartesian) ||
				 (target->coordinateType == CoordinateType::localSpherical) ||
				 (target->coordinateType == CoordinateType::spherical))
   ...
   char*                sourceWarningMessage )
{
  ...
  switch (source->coordinateType)
  {
    ...
    case CoordinateType::spherical:
	{
	  SphericalCoordinates* coordinates =
	     dynamic_cast< SphericalCoordinates* >( sourceCoordinates );
		 
	  return ((Spherical*)(source->coordinateSystem))->convertToGeodetic(
		 coordinates );
	}
	case CoordinateType::geodetic:
    {
  ...
  case CoordinateType::cylindricalEqualArea:
    ...
    case CoordinateType::localSpherical:
	{
	    SphericalCoordinates* coordinates = dynamic_cast< SphericalCoordinates* >( sourceCoordinates );
	    
		return ((LocalSpherical*)(source->coordinateSystem))->convertToGeodetic( coordinates );
	}	
	case CoordinateType::mercatorStandardParallel:
    case CoordinateType::mercatorScaleFactor:
    {
   ...
   char*                targetWarningMessage )
{
  ...
  switch (target->coordinateType)
  {
    ...
    case CoordinateType::spherical:
	{
	  ...
	  ( dynamic_cast< SphericalCoordinates& >( targetCoordinates ) ).setSphericalCoord(
	     coordinates->sphericalLongitude(), coordinates->sphericalLatitude(), coordinates->radius() );
   ...
   case CoordinateType::lambertConformalConic1Parallel:
    ...
    case CoordinateType::localSpherical:
	{
	    ...
	    ( dynamic_cast< SphericalCoordinates& >( targetCoordinates ) ).setLocalSphericalCoord(
		   coordinates->azimuth(), coordinates->elevationAngle(), coordinates->range() );
    ...
    if( _sourceCoordinates && _sourceAccuracy )
    {
      switch(targetCoordinateType)
      {
        ...
        case CoordinateType::spherical:
		{
		  ...
		  {
		    _targetCoordinates = new SphericalCoordinates(
			   CoordinateType::spherical);
			targetCoordinateExists = false;
		  }
		  try
