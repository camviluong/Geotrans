...
public class CoordinateType
{
  ...
  public final static int LOCSPHER = 17;
  public final static int MERCATOR_SP = 18;
  public final static int MERCATOR_SF = 19;
  public final static int MGRS = 20;
  public final static int MILLER = 21;
  public final static int MOLLWEIDE = 22;
  public final static int NZMG = 23;
  public final static int NEYS = 24;
  public final static int OMERC = 25;
  public final static int ORTHOGRAPHIC = 26;
  public final static int POLARSTEREO_SP = 27;
  public final static int POLARSTEREO_SF = 28;
  public final static int POLYCONIC = 29;
  public final static int SINUSOIDAL = 30;
  public final static int SPHERICAL = 31;
  public final static int STEREOGRAPHIC = 32;
  public final static int TRCYLEQA = 33;
  public final static int TRANMERC = 34;
  public final static int UPS = 35;
  public final static int UTM = 36;
  public final static int USNG = 37;
  public final static int GRINTEN = 38;
  public final static int WEBMERCATOR = 39;
  public final static int F16GRS = 40;
  ...
  public final static String LOCSPHER_STR = "Local Spherical";
  ...
  public final static String SPHERICAL_STR = "Geocentric Spherical";
  ...
  public final static String LOCSPHER_CODE = "LS";
  ...
  public final static String SPHERICAL_CODE = "SP";
  ...
  public static int index(java.lang.String name)
  {
    ...
    if(name.startsWith(GEODETIC_STR.toUpperCase()))
      ...
      return GARS;
    else if(name.startsWith(SPHERICAL_STR.toUpperCase()))
      return SPHERICAL;
    else if(name.startsWith(GEOCENTRIC_STR.toUpperCase()))
      return GEOCENTRIC;
    else if(name.startsWith(LOCCART_STR.toUpperCase()))
      return LOCCART;
    else if(name.startsWith(LOCSPHER_STR.toUpperCase()))
      return LOCSPHER;
  ...
  public static int codeIndex(java.lang.String code)
  {
    ...
    if(code.startsWith(GEODETIC_CODE))
      ...
      return LOCCART;
    else if(code.startsWith(LOCSPHER_CODE))
      return LOCSPHER;
      ...
      return SINUSOIDAL;
    else if(code.startsWith(SPHERICAL_CODE))
      return SPHERICAL;
