...
* 01/27/22  K. Lam      GTRU-28      Update version to 3.9 
*****************************************************************************/
...
{
  private final java.lang.String title = "MSP GEOTRANS 3.9";
  ...
  public double stringToDegree(java.lang.String str, java.lang.String msg)
  {
    double num = 0;

    try
    {
      num = stringToVal.stringToDouble(str) * Constants.PI_OVER_180;
    }   
    catch(CoordinateConversionException e)
    {
      errorMsg[numErrors] = msg + ": " + e.getMessage();
  ...
  public String doubleToString(final double num, final int precision)
  {
    return stringToVal.doubleToString(num, precision);
  }
