...
public class CoordPanel extends javax.swing.JPanel
{
  ...
  private void formComponentResized(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_formComponentResized
    ...
    private void setThreeCoords()
    {
        ...
        _3CoordFieldsLabelC.setText("Z");
        _3CoordFieldsLabelC.setBounds(240, 0, 70, 18);
        _3CoordFieldsLabelUnit_C.setText(" (m):");
        ...
        _3CoordFieldsLabelUnit_C.setBounds(310, 0, 70, 18);
    ...
    private void setSphericalCoords()
    {
        _2CoordFieldsPanel.setVisible(false);
        _3CoordFieldsPanel.setVisible(true);
        coordLayeredPane.moveToFront(_3CoordFieldsPanel);
        ...
        _3CoordFieldsLabelC.setBounds(296, 0, 49, 18);
        ...
        _3CoordFieldsLabelUnit_C.setBounds(349, 0, 90, 18);
  ...
  public CoordinateTuple initTargetCoordinates(int projType) throws CoordinateConversionException
  {
    switch(projType)
    {
      ...
      case CoordinateType.LOCSPHER:
        return new SphericalCoordinates(CoordinateType.LOCSPHER);
  ...
  public boolean setCoordinates(int state, int direction, int projType, CoordinateTuple _coordinates)
  {
    ...
    try
    {
      switch(projType)
      {
        ...
        case CoordinateType.SPHERICAL:
        {
          SphericalCoordinates coordinates = (SphericalCoordinates) _coordinates;

          //convert to degrees from radians
          _3CoordFieldsTextFieldA.setText(stringHandler.longitudeToString(coordinates.getAzimuth() * Constants._180_OVER_PI, useNSEW, useMinutes, useSeconds));
          _3CoordFieldsTextFieldB.setText(stringHandler.latitudeToString(coordinates.getElevAngle() * Constants._180_OVER_PI, useNSEW, useMinutes, useSeconds));
          _3CoordFieldsTextFieldC.setText(stringHandler.meterToString(coordinates.getRadius()));
  ...
  public CoordinateTuple getCoordinates(int state, int direction, int projType) throws CoordinateConversionException
  {
    switch(projType)
    {
        ...
        case CoordinateType.LOCSPHER:
        {
            SphericalCoordinates coordinates = new SphericalCoordinates(projType, 
                                               stringHandler.stringToLongitude(_3CoordFieldsTextFieldA.getText().trim(), "Invalid Azimuth"),
                                               stringHandler.stringToLatitude(_3CoordFieldsTextFieldB.getText().trim(), "Invalid Elev. Angle"),
                                               stringHandler.stringToDouble(_3CoordFieldsTextFieldC.getText().trim(), "Invalid Range"));
            return coordinates;
        }
        case CoordinateType.SPHERICAL:
        {
            SphericalCoordinates coordinates = new SphericalCoordinates(projType, 
                                               ...
                                               stringHandler.stringToDouble(_3CoordFieldsTextFieldC.getText().trim(), "Invalid Radius"));
            return coordinates;
        }
        case CoordinateType.GEODETIC:
        {
    ...
    public void createCoordPanel(int projType)
    {
        ...
        switch (projType)
        {
            ...
            { // height type
                ...
                {
                   	//italtic font
                	_3CoordFieldsLabelUnit_C.setText("(U.S. Feet):");
                	if (javax.swing.UIManager.getLookAndFeel().getName().equalsIgnoreCase("Metal"))
                		_3CoordFieldsLabelUnit_C.setFont(_3CoordFieldsLabelUnit_C.getFont().deriveFont(java.awt.Font.BOLD));
                	else
                		_3CoordFieldsLabelUnit_C.setFont(_3CoordFieldsLabelUnit_C.getFont().deriveFont(java.awt.Font.PLAIN));
                }                
            ...
            {
                setSphericalCoords();
                _3CoordFieldsLabelA.setText("Azimuth:");
                _3CoordFieldsLabelB.setText("Elevation Angle:");
                _3CoordFieldsLabelC.setText("Range");
                break;
            }
            case CoordinateType.SPHERICAL:
            {
                ...
                _3CoordFieldsLabelA.setText("Longitude:");
                _3CoordFieldsLabelB.setText("Latitude:");
                _3CoordFieldsLabelC.setText("Radius");
                break;
            }
            case CoordinateType.ALBERS:
            case CoordinateType.AZIMUTHAL:
